...
#define DESALT_NEWTYPE_WITH_ARGUMENT_GEN_PARAM_LIST_M(r, d, i, wrapped) \
    BOOST_PP_COMMA_IF(i) DESALT_PP_TUPLE_REM_IF_PAREN(wrapped) wrapped BOOST_PP_CAT(a, i)
...
#define DESALT_NEWTYPE_WITH_ARGUMENT_GEN_FORWARD_LIST_M(r, d, i, wrapped) \
    BOOST_PP_COMMA_IF(i) std::forward<DESALT_PP_TUPLE_REM_IF_PAREN(wrapped) wrapped>(BOOST_PP_CAT(a, i))
